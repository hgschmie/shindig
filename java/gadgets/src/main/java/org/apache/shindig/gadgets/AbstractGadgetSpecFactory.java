...
public abstract class AbstractGadgetSpecFactory implements GadgetSpecFactory {
  ...
  public GadgetSpec getGadgetSpec(final GadgetContext context) throws GadgetException {
    ...
    // }
    //
    // This is non-sensical and should not be here. It circumvents the cache and
    // does strange
    // things to URLs. TODO: Find out what this should do, implement it in a
    // better way.
    //
  ...
  public GadgetSpec getGadgetSpec(final URI gadgetUri, final boolean ignoreCache) throws GadgetException {
    ...
    try {
      ...
      // We could not parse the gadget spec for a reason. If the remote site is
      // down, we will
      // now hammer on it until it comes back up. Same if the Gadget is simply
      // not parsable.
      //
      // To avoid this, this adds negative caching of a minimal error gadget for
      // the URL.
