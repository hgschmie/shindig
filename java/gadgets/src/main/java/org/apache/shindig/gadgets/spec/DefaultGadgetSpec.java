...
public class DefaultGadgetSpec implements GadgetSpec {
   ...
   */
  public DefaultGadgetSpec(Uri url, String xml) throws SpecParserException {
    Element doc;
    try {
   ...
   * @param spec
   */
  private DefaultGadgetSpec(GadgetSpec spec) {
    url = spec.getUrl();
    checksum = spec.getChecksum();
  }
  ...
  public GadgetSpec substitute(Substitutions substituter) {
    DefaultGadgetSpec spec = new DefaultGadgetSpec(this);
