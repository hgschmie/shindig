...
public class MessageBundle {
  ...
  public MessageBundle(final MessageBundleSource messageBundleSource) {
    ...
    this(Collections.unmodifiableMap(convertToHash(null, messageBundleSource)), messageBundleSource
        .getLanguageDirection());
  }

  public MessageBundle(final Map<String, String> parentMessages, final Map<String, String> childMessages,
  ...
  private static Map<String, String> convertToHash(final Map<String, String> messages,
    ...
    final Map<String, String> localMessages = (messages != null) ? messages : new HashMap<String, String>(
        messageBundleSource.getLocaleMsgs().size());
